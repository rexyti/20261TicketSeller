...
filtros
útiles a los compradores.

**Why this priority**: Es importante porque dividir en categorías los recintos ayuda a tener más información sobre ellos
y que
tipo de eventos se pueden llevar a cabo en ellos.

**Independent Test**: Un administrador edita un recinto, o durante la creación de este, encuentra un selector
desplegable llamado
***Tipo de Recinto***, selecciona algún tipo y guarda. El test es exitoso si al buscar recintos en la página pública,
aparece
filtrado por esta categoría.

**Acceptance Scenarios**:

1. **Scenario: Asignar categoría a un recinto**
    - **Given** que el administrador esté creando o editando un recinto.
...
exitoso si
al comprar, el usuario puede elegir zona y el sistema respeta los límites de cada una.
