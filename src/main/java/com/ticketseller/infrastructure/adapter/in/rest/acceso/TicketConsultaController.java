...
public class TicketConsultaController {
    ...
    @Operation(summary = "Consultar estado del ticket",
            description = "Retorna el estado actual, zona, categoría y metadatos del ticket para validación de acceso.")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'COMPRADOR', 'AGENTE_VENTAS', 'CONTROLADOR_ACCESOS')")
